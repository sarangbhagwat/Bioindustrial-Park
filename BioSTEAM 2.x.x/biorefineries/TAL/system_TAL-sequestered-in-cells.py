...
def adjust_S401_cellular_TAL():
    S401._run()
    frac_to_cells = 0.99
    TAL = S401.ins[0].imol['TAL']
    S401.outs[0].imol['TAL'] = frac_to_cells * TAL
    S401.outs[1].imol['TAL'] = (1-frac_to_cells) * TAL
S401.specification = adjust_S401_cellular_TAL

pre_S402 = bst.units.Splitter('pre_S402', ins = S401-1, split = 0.95)
...
S402 = bst.units.MultiStageMixerSettlers('S402', ins = (S401-0, M402-0), 
...
M501 = bst.units.Mixer('M501', ins=(F301-1, pre_S402-1, r_S402-1, r_S403-1))
...
M505 = bst.units.Mixer('M505', ins=(S301-0, S503-1), 
